...
static uint8_t ops[16]={0,regB,regC,regD,regA,regR,regS,regM,regN,regL,regX,regI,0,0,0,0};
...
uint16_t parseInst(uint16_t* addr,uint16_t* RAM){
    ...
    *addr=addrBranch[((inst>>8)&1)&((regs[target]==0)^1)];//Updating the program counter
    ...
    printf("Value of R: %d, Value of A: %d, Value of B: %d, Value of C: %d, Value of D: %d, Value of S: %d\n",regs[regR],regs[regA],regs[regB],regs[regC],regs[regD],regs[regS]);//Debugging output for the value of register D
